...
return [
    ...
    'actions' => [
        ...
        'find_passkey' => App\Support\Passkeys\FindPasskeyToAuthenticateAction::class,
        'configure_ceremony_step_manager_factory' => App\Support\Passkeys\ConfigureCeremonyStepManagerFactoryAction::class,
    ],
    ...
    'models' => [
        ...
        'authenticatable' => env('AUTH_MODEL', App\Models\Server\User::class),
    ],
];
