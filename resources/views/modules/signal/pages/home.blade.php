<x-filament-panels::page>
    <div class="space-y-6">
        <div class="rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
            <h1 class="text-2xl font-semibold tracking-tight text-zinc-900 dark:text-zinc-100">Signal</h1>
            <p class="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                Open a channel and start chatting. The chat flow runs in the Inertia interface.
            </p>
        </div>
